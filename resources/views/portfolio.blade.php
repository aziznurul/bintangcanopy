...
<!-- Section: Layanan / Info Portfolio -->

<section id="layanan" class="max-w-7xl w-full min-h-[18rem] shadow-sm border border-blue-600 rounded-[5px] flex flex-col items-stretch justify-center px-6 md:px-16 mx-auto mt-8 py-10 bg-white overflow-hidden">
