...
<section id="sejarah" class="bg-gradient-to-t from-blue-100 to-slate-50 max-w-7xl w-full min-h-[20rem] shadow-sm border border-blue-600 rounded-[5px] flex flex-col md:flex-row items-stretch justify-center px-6 md:px-16 mx-auto mt-8 py-10 overflow-hidden">
